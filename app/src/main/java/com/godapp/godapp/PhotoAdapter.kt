...
class PhotoAdapter(var context: Context,private val cellClickListener: CellClickListener) : RecyclerView.Adapter<PhotoAdapter.ViewHolder>() {
...
class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        holder.image.setImageResource(data.image)
                ...
                holder.image.setOnClickListener(){
                        cellClickListener.onCellClickListener(data.title)
                }
